...
def processing_pipeline(input_image):
    ...
    return (input_image, clahe_image, sharpened_image, denoised_image,denoiseSharp_image,
            original_hist, clahe_hist, sharpened_hist, denoised_hist,denoiseSharp_hist,
            snr_original, snr_clahe, snr_sharpened, snr_denoised,snr_denoiseSharp,
            cnr_original, cnr_clahe, cnr_sharpened, cnr_denoised, cnr_denoiseSharp,
            psnr_original, psnr_clahe, psnr_sharpened, psnr_denoised, psnr_denoiseSharp )
...
with gr.Blocks() as demo:
    ...
    processs.click(processing_pipeline,inputs=[inputImg], outputs = [org_image,clahe_image,clahe_sharpen_image,clahe_sharpen_denoise_image, clahe_denoise_sharpen_image,
                                                                 org_image_histogram,clahe_image_histogram,clahe_sharpen_image_histogram,clahe_sharpen_denoise_image_histogram,clahe_denoise_sharpen_image_histogram,
                                                                 org_image_snr,clahe_image_snr,clahe_sharpen_image_snr,clahe_sharpen_denoise_image_snr,clahe_denoise_sharpen_image_snr ,
                                                                 org_image_cnr,clahe_image_cnr,clahe_sharpen_image_cnr,clahe_sharpen_denoise_image_cnr,clahe_denoise_sharpen_image_cnr,
                                                                 org_image_psnr,clahe_image_psnr,clahe_sharpen_image_psnr,clahe_sharpen_denoise_image_psnr,clahe_denoise_sharpen_image_psnr] )
